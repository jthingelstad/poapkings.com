...
- Clash Royale API reference lives in `~/Projects/clash-royale/cr-agent-api-docs` (github `jthingelstad/cr-agent-api-docs`), a standalone repo. This site used to carry a stale copy at `docs/cr-api-docs/`; it was removed 2026-09-07. Do not re-vendor it — read and edit the one checkout, so a finding reaches every CR project.
